      ...
      {visible && (
        <div className="fixed bottom-6 end-6 z-50 flex items-end gap-3">
          ...
          <div className="relative">
            <div className="absolute inset-0 rounded-full bg-[#25D366]/20 animate-[pulse_3s_ease-in-out_infinite]" />
            <motion.a
              href={url}
              target="_blank"
              ...
              className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-[0_4px_16px_rgba(37,211,102,0.3)] transition-shadow"
              aria-label="WhatsApp"
