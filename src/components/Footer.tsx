    ...
    <footer className="bg-cocoa text-cream">
      <div className="container mx-auto px-4 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2.5">
              <Link to="/" className="text-sm text-cream/40 hover:text-gold transition-colors">{t('nav.home')}</Link>
              <Link to="/about" className="text-sm text-cream/40 hover:text-gold transition-colors">{t('nav.about')}</Link>
              <Link to="/products" className="text-sm text-cream/40 hover:text-gold transition-colors">{t('nav.products')}</Link>
              <Link to="/contact" className="text-sm text-cream/40 hover:text-gold transition-colors">{t('nav.contact')}</Link>
            </nav>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm text-cream/40">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="tel:+40728980123" className="hover:text-gold transition-colors">0728 980 123</a>
              </div>
              <div className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 shrink-0 text-gold/60" />
                <a href="mailto:Contact.mixsweets@gmail.com" className="hover:text-gold transition-colors">Contact.mixsweets@gmail.com</a>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-5">
            ...
            <Link
              to="/contact"
              className="shine-effect inline-block bg-primary text-primary-foreground px-7 py-3.5 rounded-full text-sm font-semibold hover:shadow-[0_8px_24px_rgba(178,24,48,0.3)] transition-all"
            >
              {t('cta.button')}
            </Link>
          </div>
        ...
        <div className="mt-16 pt-8 border-t border-cream/8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-cream/25">{t('footer.rights')}</p>
          <Link to="/admin" className="text-xs text-cream/15 hover:text-cream/30 transition-colors">
            {t('footer.admin')}
          </Link>
        </div>
      </div>
