...
export const translations: Record<Language, Record<string, string>> = {
  ro: {
    ...
    // Seasonal
    'seasonal.eyebrow': '✦ PRODUSE DE TOP ✦',
    'seasonal.title': 'Produsele noastre de Top',
    'seasonal.subtitle': 'Cele mai vândute produse din Gama Magic — calitate premium și gust irezistibil.',
    ...
    'products.cod': 'COD',
    'products.weight': 'Gramaj',
    'products.cutieBox': 'Cutii pe Bax',
    'products.bucCutie': 'Bucăți pe Cutie',
    'products.baxuriPalet': 'Baxuri pe Palet',
    // Contact
    ...
    'ceofferim.item2': 'Un depozit modern situat în sud-estul României',
  ...
  en: {
    ...
    'seasonal.eyebrow': '✦ TOP PRODUCTS ✦',
    'seasonal.title': 'Our Top Products',
    'seasonal.subtitle': 'Best-selling products from the Magic Range — premium quality and irresistible taste.',
    ...
    'products.cutieBox': 'Boxes per Case',
    'products.bucCutie': 'Pieces per Box',
    'products.baxuriPalet': 'Cases per Pallet',
    ...
    'ceofferim.item2': 'A modern warehouse located in south-east Romania',
  ...
  ar: {
    ...
    'seasonal.eyebrow': '✦ أفضل المنتجات ✦',
    'seasonal.title': 'منتجاتنا الأفضل',
    'seasonal.subtitle': 'المنتجات الأكثر مبيعاً من مجموعة ماجيك — جودة فائقة وطعم لا يقاوم.',
    ...
    'products.cutieBox': 'علب لكل صندوق',
    'products.bucCutie': 'قطع لكل علبة',
    'products.baxuriPalet': 'صناديق لكل منصة',
    ...
    'ceofferim.item2': 'مستودع حديث يقع في جنوب شرق رومانيا',
