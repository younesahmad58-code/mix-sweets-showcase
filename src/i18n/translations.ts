...
export const translations: Record<Language, Record<string, string>> = {
  ro: {
    ...
    'ceofferim.item2': 'Un depozit modern situat în București',
  ...
  en: {
    ...
    'ceofferim.item2': 'A modern warehouse located in Bucharest',
  ...
  ar: {
    ...
    'ceofferim.item2': 'مستودع حديث يقع في بوخارست',
